            ...
            @foreach($allcryptos as $crypto)
                <div class="card">
                    ...
                    <form method="post">
                        ...
                        <button class="btn-light px-3 rounded" type="submit">Gem {{$crypto->RatingCount->pluck('gem_count')}}</button>
                    ...
                    <form method="post">
                        ...
                        <button class="btn-light px-3 rounded" type="submit">Scam {{$crypto->RatingCount->pluck('scam_count')}}</button>
                        @csrf
                    </form>
                </div>
            @endforeach
